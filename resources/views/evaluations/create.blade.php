...
@section('header')
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Create Evaluation Template</h2>
            <p class="text-sm text-gray-600 mt-1">
                Create a new evaluation form template
            </p>
        </div>
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <form method="POST" action="{{ route('evaluation.store') }}" class="p-6 space-y-6">
            @csrf
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700">
                            <p>After creating this template, you'll be able to:</p>
                            <ul class="list-disc list-inside mt-1 space-y-1">
                                <li>Add evaluation criteria (questions)</li>
                                <li>Set the order and importance of each criteria</li>
                                <li>Configure rating scales</li>
                                <li>Use the template in the evaluation room</li>
                            </ul>
                        </div>
                    </div>
                </div>
