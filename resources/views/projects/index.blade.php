        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="bg-gray-50 rounded-lg p-4 sm:p-6 mb-6">
                    <form method="GET" action="{{ route('project.index') }}" class="flex flex-col lg:flex-row lg:items-end gap-4">
                        <div class="flex-1">
                                ...
                                <td class="px-2 sm:px-4 py-3 sm:py-4 whitespace-nowrap">
                                    <span class="inline-flex px-1 sm:px-2 py-1 text-xs font-semibold rounded-full text-white 
                                        ...
                                        <span class="sm:hidden">
                                            @if($project->status == 'pending') Pen
                                            @elseif($project->status == 'in_progress') Pro
                                            @elseif($project->status == 'completed') Com
                                            @else {{ substr(ucfirst($project->status), 0, 3) }}
                                            @endif
                                        </span>
                                    </span>
                                </td>
                                <td class="px-2 sm:px-4 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-gray-900">
                                    {{ $project->due_date ? \Carbon\Carbon::parse($project->due_date)->format('M d, Y') : '-' }}
                                </td>
                                <td class="px-2 sm:px-4 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-gray-900">
