    ...
    <div class="py-8">
        ...
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                ...
                <p class="mt-2 text-sm text-gray-700">Create a new employee evaluation</p>
            </div>
        ...
        <!-- Evaluation Form -->
        <form action="{{ route('evaluation-room.store') }}" method="POST" class="mt-8 space-y-8">
            @csrf
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" 
                                       ...
                                       id="searchId" 
                                       value="{{ old('model_data.searchId', request('employeeId')) }}"
                                       required
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" 
                                       ...
                                       id="employeeName" 
                                       value="{{ old('model_data.employeeName') }}"
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" 
                                       ...
                                       id="department" 
                                       value="{{ old('model_data.department') }}"
                                       class="block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" 
                                       ...
                                       value="{{ old('model_data.monthlyPerformance') }}"
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="date" 
                                       ...
                                       id="evaluationDate" 
                                       value="{{ old('model_data.evaluationDate', date('Y-m-d')) }}"
                                       required
                        ...
                        <div class="flex items-center space-x-6">
                            <div class="flex items-center">
                                <input id="type-self" 
                                       ...
                                       type="radio" 
                                       value="self" 
                                       {{ old('evaluation_type', request('type')) === 'self' ? 'checked' : '' }}
                            ...
                            <div class="flex items-center">
                                <input id="type-staff" 
                                       ...
                                       type="radio" 
                                       value="staff" 
                                       {{ old('evaluation_type', request('type')) === 'staff' ? 'checked' : '' }}
                                       class="h-4 w-4 text-emerald-600 focus:ring-emerald-500 border-gray-300">
                            ...
                            <div class="flex items-center">
                                <input id="type-final" 
                                       ...
                                       type="radio" 
                                       value="final" 
                                       {{ old('evaluation_type', request('type')) === 'final' ? 'checked' : '' }}
                                       class="h-4 w-4 text-emerald-600 focus:ring-emerald-500 border-gray-300">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
                            <div class="lg:col-span-3">
                                ...
                                <textarea name="evaluation[child_evaluations][{{ $index }}][feedback]" 
                                          ...
                                          class="block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm">{{ old("evaluation.child_evaluations.{$index}.feedback") }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="evaluation[child_evaluations][{{ $index }}][rating]" 
                                    ...
                                    @for($i = 1; $i <= 5; $i++)
                                        <option value="{{ $i }}" {{ old("evaluation.child_evaluations.{$index}.rating") == $i ? 'selected' : '' }}>
                                            {{ $i }}
                                        </option>
                                    @endfor
                                </select>
